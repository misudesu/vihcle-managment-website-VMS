...
<div class="container mt-5">
        <div class="row">
            <div class="col-12">
                <br>
                <h3 class="titulo-tabla"> የድርጅቶች  ረፖርት  </h3>
                <hr>   
                                    ...
                                    <?php
                                        ...
                                        <td><?= $row['name'] ;?></td>
                                            ...
                                            <button   class=" btn btn-link text-dark text-sm mb-0 px-0 ms-4"><a class="media" href="../file/<?php echo $row['file']?>"><i class="fas fa-file-pdf text-lg me-1" aria-hidden="true"></i> PDF</a></button>
                                               ...
                                               <?php 
                                                echo "<a href='deleteview.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'> <i class='fa fa-trash' aria-hidden='true' style='color:red;'></i></a>";
                                                ?>
                                            </td>
                                        </tr>
                                    <?php
