...
<div class="container mt-5">
        <div class="row">
            <div class="col-12">
                <br>
                <h3 class="titulo-tabla">Account setting   </h3>
                <hr>   
          ...
          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2" >stutes</th>
                <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody id="myTable">
                                        ...
                                        <td><?= $row['name'] ;?></td>
                                          ...
                                          <td>
                                               ...
                                               $id=$row['id'];  ?>
                                                 ...
                                                 <a href="../driveraccount/process.php?PENDING=<?php echo $id;?>">   <button type="button"  class="btn btn-primary" name="<?php echo $id; ?>" >pending</button>
                                                 <a href="../driveraccount/process.php?reset=<?php echo $id;?>">   <button type="button"  class="btn btn-primary" name="<?php echo $id; ?>" >password reset</button>
                    ...
                    mysqli_close($conn);
                    ?>
                <a href="../signup.php" class="btn btn-success pull-left">Add New </a>
