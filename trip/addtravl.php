...
<div class="row">
      ...
      <div class="col-6">
          <p>add file for driver and also for your self</p>

        </div>
        <div class="col-4">
            <label for="name">document name</label>
<input required class="form-control" type="text" placeholder="travel...." id="name" name="name">
<div>
    <input class="form-control" required type="date" name="date">
        ...
        <div>
            <input required class="form-control" name="who">
