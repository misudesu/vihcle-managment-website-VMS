...
<style>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-12">
                <br>
                <h3 class="titulo-tabla">ወራዊ ምደባ  </h3>
                <hr>   
          ...
          <th >የሹፌር ስም</th>
            ...
            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ኮድ (የጎ/ቀጥር)</th>
                                    ...
                                    <?php
                                        ...
                                        <td><?= $row['weekoneid'] ;?></td>
                                            ...
                                            <td>
                                                ...
                                                echo "<a href='updatetrip.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip'> <i class='fa fa-edit' aria-hidden='true' style='color:#3ca23c;'></i></a>";
                    ...
                    mysqli_close($conn);
                    ?>
                <a href="addsheet.php" class="btn btn-success pull-left">Add New </a>
