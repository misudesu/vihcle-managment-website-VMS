...
$retrieve = mysqli_query($db,$sqluse);
	...
	while($foundk = mysqli_fetch_array($retrieve))
      ...
      $sqlmember ="SELECT * FROM idcard WHERE id>=$from && id<=$to";
      ...
      <div id="bg">
            <div id="id">
            	 <table>
        <tr> <td><?php  if($numb!=0 ){
                                    if($profile!=""){echo"<img src='images/$profileK'  width='70px' height='70px' alt=''>";}
									else{
      ...
      <p style="margin:auto">በዚህ መታወቅያ ላይ የሚትመለከቱት ሙሉ መረጃ በዋቸሞ ዩኒቨርሲት የውስጥ ክፍል የተረጋገጠ ነው</p>
      	<h2 style="color:#00BFFF;margin-left:2%">ዋቸሞ ዩኒቨርሲቲ </h2>
