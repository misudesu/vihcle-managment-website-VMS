...
<div class="container mt-5">
        <div class="row">
            <div class="col-12">
                <br>
                <h3 class="titulo-tabla">የነዳጅ ማመሳከርያ ሳጥን </h3>
                <hr>   
                    ...
                    ?>
                            ...
                            <table id="ejemplo" class="table table-striped table-bordered" style="width:100%" >
                                <thead>
                                    <tr>
                                    <th class="text-secondary opacity-7"> ቀን </th>
                                    <th>የመኪና ሰሌዳ  </th>
                                    <th>የመኪናው አይነት </th>
            <th>አድሱ የጌጅ ንባብ  </th>
          <th >የቀድሞ የጌጅ ንባብ </th>
            <th >ባለፈው የተሞላው ነዳጅ በሌትር </th>
            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">የአሁኑ የጌጅ ንባብ  </th>
            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">መጓዝ ያለበት ክሎ ሚርትር  </th>
            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">የሞላው ሰው ስም </th>
            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ቀር ነዳጅ </th>
                                ...
                                <tbody id="myTable">
                                    <?php
                                        ...
                                        <td><?= $row['targas'] ;?></td>
                                            ...
                                            <td><?= $row['newgej']; ?></td>
                                            <td><?= $row['privwgej'] ;?></td>
                                            <td><?= $row['prviewfull'] ;?></td>
                                            <td><?= $row['resentfull']; ?></td>
                                            <td><?= $row['musttravl'] ;?></td>
                                            <td><?= $row['name']; ?></td>
                                            <td><?= $row['kernedag']; ?></td>
                                            ...
                                            <td>
                                                <?php
                                                echo "<a href='fullview.php?id=". $row['id'] ."' title='View Record' data-toggle='tooltip'> <i class='fa fa-eye' aria-hidden='true' style='color:black'></i></a>";
                                                echo "<a href='fulldelete.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'> <i class='fa fa-trash' aria-hidden='true' style='color:red;'></i></a>";
                                                ?>
                                            </td>
                                        </tr>
                                    <?php
                    ...
                    mysqli_close($conn);
                    ?>
                <a href="make_invoice.php" class="btn btn-success pull-left">Add New </a>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
   ...
   <script>
        ...
        "autoWidth": true,
        "language": idioma,
        "lengthMenu": [[5,10,20, -1],[5,10,50,"More"]],
