...
<?php include "../home/topbar.php" ?>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-12">
                <br>
                <h3 class="titulo-tabla"> Reminder  </h3>
                <hr>   
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <a href="addcalanderEvent.php">   <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> </a>
      ...
      <form  action=" bdd.php" method="post">
         ...
         <label for="message-text" class="col-form-label"> Activity:</label>
          ...
          <div class="form-group">
            ...
            <select type="text"  name="typesof" class="form-control" id="recipient-name">
                <option value="<?=$row['title'] ?>"><?=$row['title'] ?></option>
                <option value="URGENT MEETING">URGENT MEETING </option>
                <option value="PERSONAL SCHEDULE">PERSONAL SCHEDULE</option>
                <option value="EXECUTIVES SCHEDULE">EXECUTIVES SCHEDULE</option>
            </select>
          </div>
          <div class="form-group">
...
?>
 <option value="<?=$row['colore'] ?>"><?=$red ?></option>
                ...
                <option value="text-primary">normal </option>
<?php 
            } elseif ($row['colore']=="text-warning") {
               $yelaw="yellow";
 ...
 <option value="<?=$row['colore'] ?>"><?=$yelaw ?></option>
                ...
                <option value="text-primary">normal </option>
               <?php
            } elseif ($row['colore']=="text-success") {
               $gren="green";
