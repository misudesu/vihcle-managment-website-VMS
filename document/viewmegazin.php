...
<html lang="en">
    ...
    <meta charset="utf-8">
        ...
        <link rel="stylesheet" href="../home/assets/css/https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css"> --->
         ...
         <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">file </th>
          ...
          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">permition</th>
            <th>Action</th>
                    ...
                    mysqli_close($conn);
                    ?>
                <a href="addmegazin.php" class="btn btn-success pull-left">Add New </a>
