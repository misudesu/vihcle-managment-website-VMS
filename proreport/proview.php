...
<style>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-12">
                <br>
                <h3 class="titulo-tabla">የብልሽት ሪፖርት </h3>
                <hr>   
                                    ...
                                    <?php
                                        ...
                                        <td><?= $row['name'] ;?></td>
                                           ...
                                           <td>
                                              ...
                                              <a href="../driveraccount/process.php?seen=<?php echo $id;?>">   <button type="button"  class="btn btn-primary" name="<?php echo $id; ?>" >seen</button>
<?php
                                                echo "<a href='delate.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'> <i class='fa fa-trash' aria-hidden='true' style='color:red;'></i></a>";
